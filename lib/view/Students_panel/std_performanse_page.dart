...
class StudentsPerformancePage extends StatefulWidget {
  const StudentsPerformancePage({
    super.key,
    required this.name,
  ...
  @override
  State<StudentsPerformancePage> createState() => _StudentsPerformancePageState();
}

class _StudentsPerformancePageState extends State<StudentsPerformancePage> with SingleTickerProviderStateMixin {
